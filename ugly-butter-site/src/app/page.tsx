    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-8 bg-yellow-50">
      ...
      <div className="flex flex-col items-center space-y-2">
        <Link href="/upload" className="w-full max-w-xs">
          <button className="bg-[#f2b705] text-white font-bold py-2 px-6 rounded-lg text-lg sm:text-xl w-full">
            Upload Your Butter
          </button>
        </Link>
        <Link href="/gallery" className="w-full max-w-xs">
          <button className="bg-[#f2b705] text-white font-bold py-2 px-6 rounded-lg text-lg sm:text-xl w-full">
            Churn Through Ugliness
          </button>
        </Link>
      </div>
    </main>
